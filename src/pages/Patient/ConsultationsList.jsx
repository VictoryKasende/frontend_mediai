  ...
  return (
    <div className="min-h-screen bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-light mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-white px-4 py-3 pr-10 border border-medium rounded-lg focus:border-primary focus:ring-1 focus:ring-primary transition-all duration-200 text-medical-body min-w-[160px] cursor-pointer hover:border-primary"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          {[
            ...
            <div key={index} className="bg-white rounded-lg p-4 shadow-sm border border-light">
        ...
        <div className="space-y-4">
          {filteredConsultations.length === 0 ? (
            <div className="bg-white rounded-xl p-8 shadow-sm border border-light text-center">
              <MedicalIcons.Files className="w-12 h-12 text-medium mx-auto mb-4" />
              <h3 className="text-medical-subtitle text-lg mb-2">Aucune consultation trouvée</h3>
            ...
            filteredConsultations.map((consultation) => (
              <div key={consultation.id} className="bg-white rounded-xl p-6 shadow-sm border border-light hover:shadow-md transition-shadow">
                <div className="flex flex-col lg:flex-row gap-6">
                  {/* Informations principales */}
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h3 className="text-medical-subtitle text-lg mb-1">
                          {consultation.medecin.nom}
                        </h3>
                        <p className="text-medical-caption text-primary">
                      ...
                      <div className="text-right">
                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(consultation.statut)}`}>
                    ...
                    <div className="mb-4">
                      <h4 className="font-medium text-dark mb-2">Motif de consultation</h4>
                      <p className="text-medical-body line-clamp-2">
                      ...
                      <div className="mt-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm text-orange-800 font-medium">
                            Nouveau RDV proposé: {new Date(consultation.reponse_medecin.nouveau_rdv).toLocaleDateString('fr-FR')}
                          </span>
                        </div>
                      </div>
                    )}
