...
const DoctorChatIa = () => {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex bg-surface-background font-body">
      ...
      <div className={`${sidebarCollapsed ? 'w-16' : 'w-80'} bg-white border-r border-border-primary flex flex-col transition-all duration-300`}>
        {/* Header de la sidebar */}
        <div className="p-4 border-b border-border-primary">
          <div className="flex items-center justify-between">
            {!sidebarCollapsed && (
              <h1 className="text-xl font-heading font-semibold text-content-primary">
                Conversations
              </h1>
            )}
      ...
      <div className="flex-1 flex flex-col">
        {selectedConversation ? (
          <>
            {/* Header du chat */}
            <div className="p-6 border-b border-border-primary bg-white">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="w-10 h-10 rounded-lg bg-gradient-primary flex items-center justify-center">
                    <Icon icon={MedicalIcons.AI} size="w-5 h-5" className="text-white" />
                  </div>
                  <div>
                    <h2 className="text-lg font-heading font-semibold text-content-primary">
                      Assistant Médical IA
                    </h2>
                    <p className="text-sm text-success font-body-medium flex items-center">
            ...
            {/* Zone des messages */}
            <div className="flex-1 overflow-y-auto p-6 bg-surface-background">
              <div className="max-w-4xl mx-auto space-y-6">
                ...
                {isLoading && (
                  <div className="flex justify-start">
                    ...
                    <div className="bg-white border border-border-primary rounded-2xl rounded-bl-md px-4 py-3">
            ...
            {/* Zone de saisie */}
            <div className="p-6 border-t border-border-primary bg-white">
                ...
                <div className="mb-4 flex flex-wrap gap-2">
                  {[
                    ...
                    <button
                      ...
                      className="px-3 py-2 text-sm bg-surface-muted hover:bg-surface-background border border-border-primary rounded-lg text-content-secondary hover:text-content-primary transition-colors font-body"
                    >
                      {suggestion}
                    </button>
                  ))}
                ...
                <form onSubmit={handleSendMessage} className="flex items-end space-x-3">
                  <div className="flex-1 relative">
                    <textarea
                      ...
                      disabled={isLoading}
                      rows={1}
                      className="w-full p-4 pr-16 border border-border-primary rounded-xl resize-none focus:ring-2 focus:ring-mediai-primary focus:border-transparent font-body text-content-primary placeholder-content-tertiary bg-white"
